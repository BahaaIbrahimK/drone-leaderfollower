...
class LeaderFollowerAviary(BaseMultiagentAviary):
    ...
    def _computeReward(self):
        ...
        rewards[0] = -1 * np.linalg.norm(np.array([0, 0, 0.6]) - states[0, 0:3])**2
        ...
        for i in range(1, self.NUM_DRONES):
            ...
            #rewards[i] = -0.6 * (states[i, 2] - states[0, 2]) ** 2
            #rewards[i] = -(1/self.NUM_DRONES) * np.linalg.norm(np.array([0, 0, states[0, 2]]) - states[i, 0:3])**2
